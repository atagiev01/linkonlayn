      ...
      * {
      ...
      #venue-section {
        ...
        background-image: radial-gradient(
            circle at 15% 12%,
            rgba(200, 155, 63, 0.14) 0%,
            rgba(200, 155, 63, 0) 45%
          ),
          radial-gradient(
            circle at 88% 82%,
            rgba(200, 155, 63, 0.12) 0%,
            rgba(200, 155, 63, 0) 42%
          ),
          repeating-linear-gradient(
            135deg,
            rgba(33, 31, 27, 0.02) 0px,
            rgba(33, 31, 27, 0.02) 1px,
            transparent 1px,
            transparent 14px
          );
        display: flex;
      ...
      .venue-next-btn {
        border: 1px solid var(--tpl-border, #d8d3c8);
        background: rgba(200, 155, 63, 0.06);
        color: #6b6558;
        display: flex;
        flex-direction: row;
        align-items: center;
      ...
      .venue-next-btn:hover {
        background: rgba(200, 155, 63, 0.14);
      }
      .venue-next-btn:active {
        transform: scale(0.97);
      }
      .venue-next-glow {
        color: var(--tpl-text, #211f1b);
      ...
      <main id="main-invitation">
            ...
            <div class="hero-top">
              ...
              <h1 class="names">
                ...
                ><span
                  ...
                  >&amp;</span
                ><span class="name animated-element" style="animation-delay: 0.33s"
                  >{{brideName}}</span
                >
              </h1>
            </div>
        ...
        <section class="snap-section" id="venue-section">
          <div class="venue-card" id="parallax-venue-card">
            <div class="venue-ornament animated-element">
              <span></span>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round">
                <path d="M12 21s-7-4.5-9.5-9C.5 8 2 4 6 4c2.2 0 3.6 1.3 6 4 2.4-2.7 3.8-4 6-4 4 0 5.5 4 3.5 8-2.5 4.5-9.5 9-9.5 9Z"></path>
              </svg>
              <span></span>
            </div>
            ...
            <p class="venue-title-sub animated-element" style="animation-delay: 0.07s">
              Mərasim Məkanı
            </p>
            <h2 class="venue-title animated-element" style="animation-delay: 0.13s">
              {{venue}}
            </h2>
            <div class="venue-divider animated-element" style="animation-delay: 0.17s">
              <span class="venue-line"></span>
              <span class="venue-heart">•</span>
              <span class="venue-line"></span>
            </div>
            <p class="venue-address animated-element" style="animation-delay: 0.2s">
              {{address}}
            </p>
            <div class="venue-datetime-badge animated-element" style="animation-delay: 0.27s">
              <span>{{weddingDay}} {{weddingMonth}}</span>
              <span class="venue-badge-sep">·</span>
              <span>{{weddingTime}}</span>
            </div>
            <div class="navigation-actions animated-element" style="animation-delay: 0.33s">
              <a
        ...
        <section class="snap-section" id="rsvp-section">
          <div class="rsvp-card" id="parallax-rsvp-card">
            ...
            <p class="rsvp-desc animated-element" style="animation-delay: 0.2s">
              {{customText}}
            </p>
            <div class="rsvp-buttons animated-element" style="animation-delay: 0.27s; display: flex; flex-direction: column; gap: 12px; margin-top: 24px;">
              <button
                type="button"
                class="submit-btn"
